...
#
# Usage:
#   ./scripts/single-ec2/sync-from-source.sh                # syncs all three
#   ./scripts/single-ec2/sync-from-source.sh intelli-search # syncs one
#   SOURCE=/path/to/ai-workspace ./scripts/single-ec2/sync-from-source.sh
set -euo pipefail
